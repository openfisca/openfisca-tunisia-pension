        ...
        system,
        {
            "individus": {
                "gouverneur_non_eligible": {
                    "gouverneur_duree_service": {"2024": 4}, # 1 year (4 trimesters) -> not eligible
                    "gouverneur_remuneration": {"2024": 1000}
                },
                "gouverneur_normal": {
                    "gouverneur_duree_service": {"2024": 20}, # 5 years (20 trimesters) -> 30%
                    "gouverneur_remuneration": {"2024": 1000}
                },
                "gouverneur_maxed": {
                    "gouverneur_duree_service": {"2024": 80}, # 20 years = 120% -> capped at 90%
                    "gouverneur_remuneration": {"2024": 1000}
                }
            }
        }
